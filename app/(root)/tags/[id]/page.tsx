    ...
    return(
        <>
            ...
            <div className="mt-11 w-full">
                <LocalSearch route='/' iconPosition="left" imgSrc='/assets/icons/search.svg' placeholder="Search for Tag Questions" otherClasses="flex-1" />
            </div>
            ...
            {result.questions.length>0 ? result.questions.map((question:any)=>{
                ...
                title="There are no tag questions to show" description="Be the first to break the silence! 🚀 Ask a Question and kickstart the discussion. our query could be the next big thing others learn from. Get involved! 💡"
                link='ask-question'
