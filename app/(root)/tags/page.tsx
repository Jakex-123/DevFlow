  ...
  return (
    <div className='mx-auto w-full max-w-5xl'>
        ...
        <div className='mt-11 flex flex-wrap justify-between gap-5'>
          <LocalSearch route='/tags' otherClasses={'flex-1'} iconPosition='left' placeholder='Search by tag name...' imgSrc='/assets/icons/search.svg'/>
          <Filter filters={TagFilters} otherClasses={'min-h-[56px] sm:min-w-[170px]'}/>
        </div>
        <section className='mt-11 flex flex-wrap gap-4'>
          {results?.tags?.length>0?(results.tags.map((tag)=>{
